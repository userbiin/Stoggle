...
export const mockRelations = {
  ...
  links: [
    ...
    { source: "005930", target: "066570", value: 0.75, type: "계열사" },
    { source: "005930", target: "003550", value: 0.70, type: "계열사" },
    { source: "005930", target: "207940", value: 0.58, type: "계열사" },
  ...
  related_companies: [
    { ticker: "000660", name: "SK하이닉스", correlation: 0.82, reason: "메모리 반도체 직접 경쟁사", relation_type: "경쟁" },
    { ticker: "066570", name: "LG전자",     correlation: 0.75, reason: "가전·디스플레이 사업 경쟁", relation_type: "경쟁" },
    { ticker: "003550", name: "LG",         correlation: 0.70, reason: "그룹사 연관 지수 동반 움직임", relation_type: "계열사" },
